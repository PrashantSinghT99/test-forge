...
def call_ollama(failed_selector: str, candidates: List[Dict], url: str = "http://localhost:11434") -> Optional[str]:
...
def call_huggingface(failed_selector: str, candidates: List[Dict], token: str) -> Optional[str]:
...
def call_gemini(failed_selector: str, candidates: List[Dict], api_key: str) -> Optional[str]:
